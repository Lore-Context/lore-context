...
.benchmark-chart{display:grid;gap:16px;padding:18px}.chart-toolbar{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap}.chart-toolbar strong,.chart-toolbar span{display:block}.chart-toolbar strong{font-size:15px}.chart-toolbar span{color:var(--muted);font:12px ui-monospace,SFMono-Regular,Menlo,monospace}.chart-legend{display:flex;align-items:center;gap:14px;flex-wrap:wrap}.chart-legend span{display:inline-flex;align-items:center;gap:7px;color:var(--muted);font:12px ui-monospace,SFMono-Regular,Menlo,monospace}.legend-dot{display:inline-block;width:10px;height:10px;border-radius:50%}.legend-dot.lore{background:var(--green)}.legend-dot.mem0{background:var(--amber)}.chart-grid{display:grid;gap:0;border:1px solid var(--line);border-radius:8px;overflow:hidden;background:var(--paper)}.comparison-row{display:grid;grid-template-columns:180px 1fr;gap:18px;align-items:center;padding:16px;border-bottom:1px solid var(--line)}.comparison-row:last-child{border-bottom:0}.comparison-label strong{display:block;font-size:14px}.comparison-label small{display:block;margin-top:5px;color:var(--muted);font:11px ui-monospace,SFMono-Regular,Menlo,monospace}.comparison-bars{display:grid;gap:8px}.comparison-bar{display:grid;grid-template-columns:72px minmax(140px,1fr) 92px;gap:10px;align-items:center;font:12px ui-monospace,SFMono-Regular,Menlo,monospace}.comparison-bar span{color:var(--muted)}.comparison-bar b{display:block;height:18px;border-radius:5px;background:rgba(0,0,0,.08);overflow:hidden}.comparison-bar i{display:block;height:100%;min-width:6px;border-radius:5px;background:var(--green);animation:barReveal 1.4s ease-out both}.comparison-bar.mem0 i{background:var(--amber)}.comparison-bar i.zero{min-width:0}.comparison-bar em{font-style:normal;text-align:right;color:#1d2730;font-weight:900}.chart-note{margin:0;color:var(--muted);font-size:12px}
