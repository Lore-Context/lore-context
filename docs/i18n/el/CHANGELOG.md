...
- Όλα τα ευρήματα ελέγχου P0 (loopback bypass / dashboard auth / rate limit / demo
  secrets) εκκαθαρίστηκαν. Δείτε `Lore_Context_项目计划书_2026-04-27.md` και
  `.omc/plans/lore-prelaunch-fixes-2026-04-28.md` για το πλήρες αρχείο ελέγχου.
...
artifacts ελέγχου διατηρούνται στο `.omc/plans/`.
