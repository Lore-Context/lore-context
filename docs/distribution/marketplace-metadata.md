...
|---|---:|---|
| MCP registry / MCP hub | Official Registry published; hubs draft-ready | Official MCP Registry is active and lists npm `@lore-context/server@0.6.0-alpha.1` plus OCI `ghcr.io/lore-context/lore-context-mcp:0.6.0-alpha.1`. Use [mcp-registry.md](mcp-registry.md) and [assets](assets/) for hub submissions. |
